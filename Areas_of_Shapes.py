...
print (f"The area of the square is: {str(square_area)}")

rect_leng = float(input('What is the length of rectangle? '))
rect_wid = float(input('What is the width of the rectangle? '))
rect_area = rect_leng * rect_wid
